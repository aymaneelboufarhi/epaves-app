        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item {{ request()->routeIs('register') ? 'active' : '' }}">
            <a href="{{ route('register') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-user-plus"></i> <!-- Updated icon -->
              <div data-i18n="Analytics">Créer un Nouveau Compte</div>
            </a>
          </li>
          <li class="menu-item {{ request()->routeIs('liste') ? 'active' : '' }}">
            <a href="{{ route('liste') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-grid-alt"></i> <!-- Updated icon -->
              <div data-i18n="Analytics">Tableau de Bord</div>
            </a>
          </li>
          <li class="menu-item {{ request()->routeIs('epave') ? 'active' : '' }}">
            <a href="{{ route('epave') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-search-alt"></i> <!-- Updated icon -->
              <div data-i18n="Analytics">Gestion des Épaves</div>
            </a>
          </li>
          <li class="menu-item {{ request()->routeIs('admin.rapatriements') ? 'active' : '' }}">
            <a href="{{ route('admin.rapatriements') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-search-alt"></i>
              <div data-i18n="Analytics">Rapatriement des Épaves</div>
            </a>
          </li>

          <li class="menu-item {{ request()->routeIs('recuperation') ? 'active' : '' }}">
            <a href="#" class="menu-link">
              <i class="menu-icon tf-icons bx bx-recycle"></i> <!-- Updated icon -->
              <div data-i18n="Analytics">Récupération des Épaves</div>
            </a>
          </li>
        </ul>
      </aside>
